...
#categoriesDisplay .border {
    transition: transform 0.3s;
}

#categoriesDisplay .border:hover {
...
<div id="content" class="ml-40 flex-1 transition-all duration-300">
    ...
    <div id="productsContainer" class="container mx-auto p-4 transition-all duration-300">
        ...
        <!-- Add sections for Home Decor, Pop Culture Items, etc., similarly -->
    </div>
</div>
...
const categories = {
    gadgetsToys: ["Gadget 1", "Toy 1", "Gadget 2", "Toy 2", "Gadget 3", "Toy 3", "Game 1", "Game 2", "Game 3"],
    homeInterior: ["Living Room 1", "Kitchen 1", "Bathroom 1", "Workspace 1", "Tokyo Olympics 1", "Living Room 2", "Kitchen 2", "Bathroom 2", "Workspace 2"],
    healthBeauty: ["Beauty Gadget 1", "Massage Good 1", "Cosmetic 1", "Face Pack 1", "Hair Care 1", "Beauty Gadget 2", "Massage Good 2", "Cosmetic 2", "Face Pack 2"],
    fashionLifestyle: ["Men 1", "Women 1", "Kids 1", "Pets 1", "Men 2", "Women 2", "Kids 2", "Pets 2", "Men 3"],
};
...
function displayCategories(categories) {
    ...
    for (const [category, items] of Object.entries(categories)) {
        ...
        categoryTitle.className = "text-lg font-semibold mb-4";
        categoryTitle.textContent = category.replace(/([A-Z])/g, " $1").trim();

        const categoryItems = document.createElement("div");
        categoryItems.className = "grid grid-cols-3 gap-6";

        items.slice(0, 9).forEach((item) => {
            const itemCard = document.createElement("div");
            itemCard.className = "border border-gray-300 rounded-lg shadow-sm p-4 text-center";
